      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Skoolar Platform</h1>
        ...
        >
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mb-4">
              ...
              <input
                type="email"
                placeholder="manufacturer@skoolar.com"
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">
                    This portal is for authorized Skoolar platform administrators only. All access attempts are logged and monitored.
                  </p>
                </div>
              </div>
            </div>
        ...
        >
          <p className="text-xs text-gray-500">
            Skoolar Platform v1.0 • Secure Access Portal
          </p>
        </motion.div>
      </motion.div>
    </div>
